...
trace = sys.argv[2]
logTask = trace + '-tasks-electrical' + str(sys.argv[3]) + '.csv'
logJob = trace + '-jobs-electrical' + str(sys.argv[3]) + '.csv'
logComplTime = trace + '-jobCompletionTime-electrical' + str(sys.argv[3]) + '.csv'
...
with open('/Users/sherry/Box Sync/Hadoop-simulation-electrical/input/SWIM/'+trace+'.csv', 'r') as csvfile, open (outputCPU, 'wt') as output:
