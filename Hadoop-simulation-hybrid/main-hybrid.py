...
sys.path.insert(0, '/scratch/xw5ce/Hadoop-simulation-hybrid')
import simpy, csv
...
trace = 'numSHJ' + str(sys.argv[1]) + '_SHJRatio' + str(int(sys.argv[2])) + '%_arrivalRate' + str(sys.argv[3]) + '_' + str(sys.argv[4])
workload = '/scratch/xw5ce/Hadoop-simulation-hybrid/input/SWIM/' + trace + '.csv'
L.logJobCompletionTime = 'logs/' + trace + '-jobCompletionTime-hybrid.csv'
L.logTasks = 'logs/' + trace + '-tasks-hybrid.csv'
L.logJobs = 'logs/' + trace + '-jobs-hybrid.csv'
L.logOptical = 'logs/' + trace + '-optical.csv'
L.logCPUUtil = 'logs/' + trace + '-cpuUtil-hybrid.csv'
